...
*/
var currentOrders = {
  order11821_k: order11821,
  order11372_g: order11372
}
/*
...
*/
order11821.pizza.PizzaSauce = "classic marinara";
order11821.pizza.Toppings.Veggies.push("Spinach");
order11821.pizza.Toppings.Meats.pop();
order11821.orderTime = "20 Minutes B";

for(var i in currentOrders) {
  for(var j in currentOrders[i]){
    console.log(currentOrders[i][j]);
  }
  console.log("\n");
}
//console.log(temp);